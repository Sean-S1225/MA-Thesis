...
When we looked at the different p53 hotspot mutations, we saw that, through the metrics used to analyze the preliminary data, many mutations do not have drastic differences from the WT p53. We also saw that there were several mutations, both conformational and DNA contacting, such as V157F, that seem to be rescued by PK11000.
